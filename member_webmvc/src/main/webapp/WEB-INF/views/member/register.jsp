...
<h1>회원 가입</h1>
<form action='<c:url value ="/member/register"></c:url>' method="post"
	novalidate>
	<!-- 
 ...
 -->
	...
	<div class="mb-3">
		<label for="name" class="form-label">이름</label> <input type="text"
			class="form-control" id="name" name="name" placeholder="이름" required
			pattern="^[가-힣]{2,5}$">
		<div class="invalid-feedback">이름을 확인해 주세요</div>
	</div>
	<div class="mb-3">
		<label for="gender" class="form-label">성별</label> <input type="radio"
			class="form-check-input" id="gender" name="gender" value="남" required />
		남 <input type="radio" class="form-check-input" id="gender"
			name="gender" value="여" required /> 여
		<div class="invalid-feedback">성별을 확인해 주세요</div>
	</div>
	<div class="mb-3">
		<label for="description" class="form-label">이메일</label> <input
