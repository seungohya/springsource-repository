...
<form action='<c:url value="/book/search"/>' id="search-form"
	class="row g-3 justify-content-center">
	<div class="col-auto">
		<select class="form-selet" name="criteria">
			<option ${searchDto.criteria == 'null' ? 'selected' : ''}>검색기준
				선택</option>
			<option value="writer"
				<c:out value = "${searchDto.criteria}== 'writer'? 'selected' :''}"/>>writer</option>
			<option value="title"
	...
	<div class="col-md-5">
		<input type="text" class="form-control" name="keyword"
			placeholder="검색어" value='${searchDto.keyword}'>
	</div>
	<div class="col-auto">
