...
<%@ include file="../include/header.jsp" %>
	<h1>도서 정보 수정</h1>
	<form action='<c:url value ="/book/modify"></c:url>' method="post">
	  <div class="mb-3">
	  ...
	  <div class="mb-3">
	    ...
	    <textarea class="form-control" id="description" name="description" readonly>자세한 정보와 그림</textarea>    
	  </div>   
	...
	const removePath =  "<c:url value='/book/delete'/>";
