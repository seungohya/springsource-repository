...
<script src="/resources/js/lightbox/lightbox.min.js"></script><!-- jquery 를 기반으로 하는거라 jquery 가 먼저나오고 밑에 와야한다. -->
<!--upload scc  -->
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span> <img class="/resources/img-profile rounded-circle" src="/resources/img/undraw_profile.svg">
