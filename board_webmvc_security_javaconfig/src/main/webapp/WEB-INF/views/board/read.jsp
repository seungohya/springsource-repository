	...
	<div class="col">
		<form action="" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="title" name="title" readonly value="${read.title}">
			</div>
...
<!-- 댓글 작성 폼 -->
	<security:authorize access ="isAuthenticated()">
<form action="" id="replyForm" calss="mt-3">
	<div class="form-row">
		<div class="col-11">
		...
		<div class="col my-2">
			<div class="from-row my-2">
				<input type="text" name="replyer" id="replyer" class="form-control" value='<security:authentication property="principal.username"/>' readonly/>
			</div>
			<div class="from-row my-2">
				<button class="btn btn-success btn-block">댓글작성</button>
			</div>
		</div>
	</div>
</form>
